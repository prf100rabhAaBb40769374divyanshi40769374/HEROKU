...
REPO_URL = "https://github.com/SEX-SUX/ANON"
BRANCH_NAME = None
BUILDPACK_URL = "https://github.com/heroku/heroku-buildpack-python"
UPSTREAM_REPO = "https://github.com/SEX-SUX/ANON"  # Pre-defined variable
    ...
    buttons = [
        [
            InlineKeyboardButton(
                convert_to_small_caps("NEXIO MSUIC REPO"), callback_data="deploy_upstream"
            ),
        ],
        [
            InlineKeyboardButton(
